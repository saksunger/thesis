...
% Maximum section depth (chapter.section.subsection.subsubsection).
\setcounter{secnumdepth}{4}

% Listings settings (minted; requires -shell-escape + Pygments on compile).
...
% ---- Title-page metadata -------------------------------------------------
\fieldofstudy{Applied Computer Science}     % TODO: confirm field/spec code on title-page list
\author{Sevda Aksünger}
\title{Machine-Learning-Based Anomaly and Drift-Aware Monitoring for Handover Optimization in 5G/6G Radio Access Networks}
